...
export const DOCTORS: Doctor[] = [
  ...
  { id: 'card2', name: 'ডাঃ মোঃ মাহফুজ আলী', degree: 'MBBS, BCS (Health), FCPS (Medicine), D-Card', specialty: 'Cardiology', districts: ['Nilphamari'], clinics: ['c-greensign'], schedule: 'Sat-Thu: 3 PM - 10 PM', availableToday: true, rating: 4.8, image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=200', consultationFee: 600 },

  // --- Neuromedicine ---
  { id: 'neuro1', name: 'ডাঃ মোঃ আসাদুজ্জামান (আসাদ)', degree: 'MBBS, BCS (Health), FCPS (Medicine), MD (Neurology)', specialty: 'Neuromedicine', districts: ['Nilphamari'], clinics: ['c-greensign'], schedule: 'Fri: 10 AM - 8 PM', availableToday: false, rating: 4.9, image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=200', consultationFee: 800 },
  ...
  { id: 'gyn2', name: 'ডাঃ রুমানা আফরোজ', degree: 'MBBS, PGT, EOCT, DMU, CCD, MPH', specialty: 'Gynecology', districts: ['Nilphamari'], clinics: ['c-greensign'], schedule: 'Sat-Thu: 4 PM-10 PM', availableToday: true, rating: 4.9, image: 'https://images.unsplash.com/photo-1614608682850-e0d6ed316d47?auto=format&fit=crop&q=80&w=200', consultationFee: 500 },
  { id: 'gyn3', name: 'ডাঃ শাহনাজ বেগম', degree: 'MBBS, FCPS, MS (Gynae)', specialty: 'Gynecology', districts: ['Nilphamari'], clinics: ['c-ar'], schedule: 'Daily: 10 AM - 2 PM', availableToday: true, rating: 4.8, image: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?auto=format&fit=crop&q=80&w=200', consultationFee: 600 },
  ...
  // --- Surgery ---
  { id: 'sur1', name: 'ডাঃ মোঃ এমদাদুল হক', degree: 'MBBS, FCPS (Surgery)', specialty: 'Surgery', districts: ['Nilphamari'], clinics: ['c-greensign'], schedule: 'Daily: 4 PM - 9 PM', availableToday: true, rating: 4.8, image: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&q=80&w=200', consultationFee: 700 },
  ...
  // --- ENT ---
  { id: 'ent2', name: 'ডাঃ মোঃ রাশিদুল ইসলাম', degree: 'MBBS, DLO (ENT)', specialty: 'ENT', districts: ['Nilphamari'], clinics: ['c-ar'], schedule: 'Sat-Thu: 5 PM - 9 PM', availableToday: true, rating: 4.8, image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=200', consultationFee: 500 },

  // --- Dermatology ---
  { id: 'derm1', name: 'ডাঃ ফাহিম কিশওয়ার', degree: 'MBBS, DDV, CCD, FCPS', specialty: 'Dermatology', districts: ['Nilphamari'], clinics: ['c-ar'], schedule: 'Fri: 3 PM - 9 PM', availableToday: false, rating: 4.8, image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=200', consultationFee: 600 },
  ...
  // --- Psychiatry ---
  { id: 'psy2', name: 'ডাঃ মোঃ এনামুল হক', degree: 'MBBS, MD (Psychiatry)', specialty: 'Psychiatry', districts: ['Nilphamari'], clinics: ['c-madina'], schedule: 'Daily: 6 PM - 9 PM', availableToday: true, rating: 4.8, image: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&q=80&w=200', consultationFee: 1000 },
  ...
  { id: 'j-gyn1', name: 'ডাঃ পারুল রানী রায়', degree: 'MBBS, DGO (Dhaka), FCPS (LP) Gynae & Obs', specialty: 'Gynecology', districts: ['Nilphamari'], clinics: ['c-janata'], schedule: 'Daily: 10 AM - 2 PM & 4 PM - 8 PM', availableToday: true, rating: 4.9, image: 'https://images.unsplash.com/photo-1527613426441-4da17471b66d?auto=format&fit=crop&q=80&w=200', consultationFee: 500 },
  { id: 'j-gyn2', name: 'ডাঃ ফারজানা আক্তার', degree: 'MBBS, BCS (Health), CMU, DMU (Ultrasonology)', specialty: 'Gynecology', districts: ['Nilphamari'], clinics: ['c-janata'], schedule: 'Daily: 3 PM - 8 PM', availableToday: true, rating: 4.8, image: 'https://images.unsplash.com/photo-1623854767233-2d2c322cc4e2?auto=format&fit=crop&q=80&w=200', consultationFee: 500 },
