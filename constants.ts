...
export const DOCTORS: Doctor[] = [
  ...
  // --- Cardiology ---
  { id: 'card1', name: 'Dr. Md. Asad Alam', degree: 'MBBS, BCS (Health), CCD (BIRDEM), D-Card (BSMMU)', specialty: 'Cardiology', districts: ['Nilphamari'], clinics: ['c-greensign'], schedule: 'প্রতিদিন: বিকাল ৩:০০ - রাত ৯:০০', availableToday: true, rating: 4.9, image: 'input_file_0.png', consultationFee: 600 },
  ...
  { id: 'gyn-ibadat', name: 'Dr. Mosammat Sharmin Akter', degree: 'MBBS, BCS (Health), MS (Gynae)', specialty: 'Gynecology', districts: ['Nilphamari'], clinics: ['c-ibadat'], schedule: 'প্রতিদিন: বিকাল ২:০০ - রাত ৮:০০', availableToday: true, rating: 4.8, image: 'https://images.unsplash.com/photo-1559839734-2b71f1536780?auto=format&fit=crop&q=80&w=200', consultationFee: 600 },
  ...
  { id: 'j-gyn1', name: 'Dr. Parul Rani Roy', degree: 'MBBS, DGO (Dhaka), FCPS (LP) Gynae & Obs', specialty: 'Gynecology', districts: ['Nilphamari'], clinics: ['c-janata'], schedule: 'প্রতিদিন: সকাল ১০-২ ও বিকাল ৪-৮', availableToday: true, rating: 4.9, image: 'https://images.unsplash.com/photo-1527613426441-4da17471b66d?auto=format&fit=crop&q=80&w=200', consultationFee: 500 },
  ...
  { id: 'j-gyn3', name: 'Dr. Afroza Khanom', degree: 'MBBS (BUP), CMU, DMU (Ultra)', specialty: 'Gynecology', districts: ['Nilphamari'], clinics: ['c-janata'], schedule: 'প্রতিদিন: সকাল ১০:০০ - রাত ৮:০০', availableToday: true, rating: 4.7, image: 'https://images.unsplash.com/photo-1559839734-2b71f1536780?auto=format&fit=crop&q=80&w=200', consultationFee: 400 },
  ...
  { id: 'j-med2', name: 'Dr. Tawhida Nasrin', degree: 'MBBS, BCS (Health), FCPS (Medicine) Final Part, DMU', specialty: 'Medicine', districts: ['Nilphamari'], clinics: ['c-janata'], schedule: 'শুক্রবার: সকাল ১০:০০ - রাত ৮:০০', availableToday: false, rating: 4.7, image: 'https://images.unsplash.com/photo-1559839734-2b71f1536780?auto=format&fit=crop&q=80&w=200', consultationFee: 500 },
  ...
  { id: 'j-med5', name: 'Dr. Rituparna Roy', degree: 'MBBS (BUP), CMU (Ultra)', specialty: 'Medicine', districts: ['Nilphamari'], clinics: ['c-janata'], schedule: 'প্রতিদিন: দুপুর ২:০০ - রাত ১০:০০', availableToday: true, rating: 4.7, image: 'https://images.unsplash.com/photo-1559839734-2b71f1536780?auto=format&fit=crop&q=80&w=200', consultationFee: 400 },
];
